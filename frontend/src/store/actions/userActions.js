...
export const registerUser = userData => {
    return async dispatch => {
        try {
            ...
            toast.success('🫶 Registration was successful, now log in ', {position: 'bottom-right', autoClose: 2000});
        } catch (e) {
...
export const loginUser = userData => {
    return async dispatch => {
        try {
            ...
            toast.success('😊 You are successfully logged in', {position: 'bottom-right', autoClose: 2000});
        } catch (e) {
            if (e.response && e.response.data) {
...
export const logoutUser = () => {
    return async (dispatch, getState) => {
        try {
            ...
            dispatch(historyPush('/'));
            toast.error('🤧 You logged out of the account', {position: 'top-center', autoClose: 2000});
        } catch (e) {
